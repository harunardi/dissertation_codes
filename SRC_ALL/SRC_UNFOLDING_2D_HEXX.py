...
##### Noise Simulation
    ...
    matrix_builder = MatrixBuilderNoise2DHexx(group, I_max, J_max, N_hexx, conv_tri, conv_neighbor, TOT, SIGS_reshaped, BC, h, level, D, chi, NUFIS, keff, v, Beff, omega, l, dTOT, dSIGS_reshaped, dNUFIS, noise_section, type_noise)
...
#######################################################################################################
def main_unfold_2D_hexx_base(group, I_max, J_max, N_hexx, conv_tri, conv_neighbor, TOT, SIGS_reshaped, BC, h, level, D, chi, NUFIS, keff, v, Beff, omega, l, dTOT_hexx, dSIGS_hexx, chi_hexx, dNUFIS_hexx, noise_section, type_noise, map_detector_hexx, case_name, case_name_base, case_name2):
...
def main_unfold_2D_hexx_old_methods(dPHI_temp_meas, dPHI_temp, S, G_matrix, group, I_max, J_max, N_hexx, conv_tri, level, D, map_detector_hexx, case_name, case_name_base, validity_INVERT, validity_ZONE, validity_SCAN):
    output_dir = f'OUTPUTS/{case_name_base}/{case_name}_UNFOLDING'
...
def main_unfold_2D_hexx_brute(dPHI_temp_meas, dPHI_temp, S, G_matrix, group, I_max, J_max, N_hexx, conv_tri, level, D, map_detector_hexx, case_name, case_name_base, validity_BRUTE):
    output_dir = f'OUTPUTS/{case_name_base}/{case_name}_UNFOLDING'
...
def main_unfold_2D_hexx_back(dPHI_temp_meas, dPHI_temp, S, G_matrix, group, I_max, J_max, N_hexx, conv_tri, level, D, case_name, case_name_base, validity_BACK):
    output_dir = f'OUTPUTS/{case_name_base}/{case_name}_UNFOLDING'
...
def main_unfold_2D_hexx_greedy(dPHI_temp_meas, dPHI_temp, S, G_matrix, group, I_max, J_max, N_hexx, conv_tri, level, D, map_detector_hexx, case_name, case_name_base, validity_GREEDY):
    output_dir = f'OUTPUTS/{case_name_base}/{case_name}_UNFOLDING'
...
##### 08. GREEDY
    ...
    return dPHI_temp_GREEDY, dS_unfold_GREEDY_temp, validity_GREEDY
