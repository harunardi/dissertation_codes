...
from INPUTS.TASK3_TEST03a_2DMG_PWRMOX1_1SRC_AVS_NONCENTER import *
#from INPUTS.TASK3_TEST03b_2DMG_PWRMOX1_2SRC_AVS_NONCENTER import *
#from INPUTS.TASK3_TEST03c_2DMG_PWRMOX1_3SRC_AVS_NONCENTER import *
#from INPUTS.TASK3_TEST03d_2DMG_PWRMOX1_1SRC_21DET_AVS_NONCENTER import *
#from INPUTS.TASK3_TEST03e_2DMG_PWRMOX1_1SRC_10DET_AVS_NONCENTER import *
#from INPUTS.TASK3_TEST03f_2DMG_PWRMOX1_1SRC_5DET_AVS_NONCENTER import *
#from INPUTS.TASK3_TEST03g_2DMG_PWRMOX1_1SRC_1DET_AVS_NONCENTER import *
#from INPUTS.TASK3_TEST03h_2DMG_PWRMOX1_TAVS_NONCENTER import *
        ...
        for n in range(N):
            if conv[n] != 0:
               ...
               # Save output to HDF5 file
                hdf5_filename = f'{output_dir}/{case_name}_UNFOLDING/{case_name}_01_GENERATE/Green_g{g+1}_k{k+1}_j{j+1}_i{i+1}.h5'
