...
#######################################################################################################
def main_unfold_1D(group, N, TOT, SIGS, BC, dx, D, chi, NUFIS, precond, v, Beff, omega, l, dTOT, dSIGS, dNUFIS, dSOURCE, map_detector, case_name, case_name_base, x, validity_INVERT, validity_SCAN, validity_BRUTE, validity_BACK, validity_GREEDY):
...
##### 08. GREEDY
    ...
    return validity_INVERT, validity_SCAN, validity_BRUTE, validity_BACK, validity_GREEDY
