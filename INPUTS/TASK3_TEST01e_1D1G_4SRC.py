...
################################################################
case_name = "TASK3_TEST01e_1D1G_4SRC"
...
index_S1 = int((xp1 + a) / dx)
index_S2 = int((xp2 + a) / dx)
index_S3 = int((xp3 + a) / dx)
index_S4 = int((xp4 + a) / dx)
dSOURCE1[index_S1] = 1.0
dSOURCE1[index_S2] = 2.0
dSOURCE1[index_S3] = 3.0
dSOURCE1[index_S4] = 4.0
dSOURCE = dSOURCE1
print(index_S1+1, index_S2+1, index_S3+1, index_S4+1)
